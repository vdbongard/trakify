...
export const API = {
  ...
  syncWatchedShows: `${Config.traktBaseUrl}/sync/watched/shows?extended=noseasons&page=%&limit=%`,
  ...
  showsAnticipated: `${Config.traktBaseUrl}/shows/anticipated?limit=40&extended=full`,
