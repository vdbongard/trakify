...
describe('AddListDialogComponent', () => {
  ...
  it('should not close the dialog when Create is clicked and name is empty', async () => {
  ...
  it('should close the dialog with no payload when Cancel button is clicked', async () => {
